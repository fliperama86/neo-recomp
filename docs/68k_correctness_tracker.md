...
5. **Dispatch and metadata audit enforcement**: expand `games/*.toml` beyond
   function/discovery-file/jump-table metadata, broaden dispatch-audit target
   patterns, and fail smoke runs on unresolved/missing control-flow gaps.
