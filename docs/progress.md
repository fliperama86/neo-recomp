...
the harness only has a first-pass state oracle (dispatch counts, RAM/VRAM
checksums, and a short recent-dispatch loop detector), not a frame or
boot/attract-mode success oracle.
