...
#define NG_EXEC_FIXTURE_ADDR_COUNT 149u
...
static void ng_exec_fixture_fill(uint8_t *data, uint32_t size) {
    ...
    {
        uint32_t pc = 0x5F40u;
        ng_exec_fixture_write16(data, pc, 0x4E57u); /* LINK A7,#-4 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0xFFFCu);
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5F50u;
        ng_exec_fixture_write16(data, pc, 0x4E5Fu); /* UNLK A7 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x40F9u); /* MOVE SR,$0000128C */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x0000128Cu);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5F60u;
        ng_exec_fixture_write16(data, pc, 0x2F0Fu); /* MOVE.L A7,-(A7) */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x23D7u); /* MOVE.L (A7),$00001290 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x00001290u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x40F9u); /* MOVE SR,$00001294 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x00001294u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5F80u;
        ng_exec_fixture_write16(data, pc, 0x4857u); /* PEA (A7) */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x40F9u); /* MOVE SR,$0000129C */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x0000129Cu);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x23D7u); /* MOVE.L (A7),$00001298 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x00001298u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5FA0u;
        ng_exec_fixture_write16(data, pc, 0x4EAFu); /* JSR ($5EE0,A7) */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x5EE0u);
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x40F9u); /* MOVE SR,$000012A0 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x000012A0u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5FE0u;
        ng_exec_fixture_write16(data, pc, 0x33FCu); /* MOVE.W #$CAFE,$000012A2 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0xCAFEu);
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x000012A2u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E75u); /* RTS */
    }

    {
        uint32_t pc = 0x5FB0u;
        ng_exec_fixture_write16(data, pc, 0x4EBBu); /* JSR ($0005FB6,PC,D0.W) */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x0004u);
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x40F9u); /* MOVE SR,$000012A4 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x000012A4u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
    ...
    {
        uint32_t pc = 0x5FC0u;
        ng_exec_fixture_write16(data, pc, 0x41F8u); /* LEA $FFFF.W,A0 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0xFFFFu);
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x23C8u); /* MOVE.L A0,$000012A6 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x000012A6u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x2E7Cu); /* MOVEA.L #$00000270,A7 */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x00000270u);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4878u); /* PEA $FFFF.W */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0xFFFFu);
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x23D7u); /* MOVE.L (A7),$000012AA */
        pc += 2u;
        ng_exec_fixture_write32(data, pc, 0x000012AAu);
        pc += 4u;
        ng_exec_fixture_write16(data, pc, 0x4E72u); /* STOP #$2700 */
        pc += 2u;
        ng_exec_fixture_write16(data, pc, 0x2700u);
