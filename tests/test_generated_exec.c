...
static int oracle_exec(const uint8_t *program,
    ...
    for (uint32_t step = 0; step < 192u; ++step) {
        ...
        if ((op & 0xFFF8u) == 0x4E50u) {
            ...
            uint32_t old_an = state->a[reg];
            state->a[7] -= 4u;
            bus_write32(bus, state->a[7], old_an);
...
int main(void) {
    ...
    expected_state.a[7] = 0x000001F0u;
    expected_state.ssp = expected_state.a[7];
    CHECK(oracle_exec(program, (uint32_t)sizeof(program), 0x00005F40u,
                      &expected_state, expected_bus, 0));
    CHECK(expected_state.a[7] == 0x000001E8u);
    CHECK(bus_read32(expected_bus, 0x000001ECu) == 0x000001F0u);
    ...
    expected_state.a[7] = 0x000001F0u;
    expected_state.ssp = expected_state.a[7];
    CHECK(oracle_exec(program, (uint32_t)sizeof(program), 0x00005F60u,
                      &expected_state, expected_bus, 0));
    CHECK(expected_state.a[7] == 0x000001ECu);
    CHECK(bus_read32(expected_bus, 0x000001ECu) == 0x000001F0u);
    CHECK(bus_read32(expected_bus, 0x00001290u) == 0x000001F0u);
    CHECK(bus_read16(expected_bus, 0x00001294u) == (uint16_t)(SR_S | CCR_X));
    ...
    ng_generated_call(0x00005F60u);

    CHECK(g_dispatch_miss_count == 0);
    CHECK(g_ng_m68k.a[7] == expected_state.a[7]);
    CHECK(g_ng_m68k.sr == expected_state.sr);
    CHECK(ng68k_read32(0x000001ECu) == 0x000001F0u);
    CHECK(ng68k_read32(0x00001290u) == 0x000001F0u);
    CHECK(ng68k_read16(0x00001294u) == (uint16_t)(SR_S | CCR_X));
    CHECK(memcmp(g_bus, expected_bus, sizeof(g_bus)) == 0);
    CHECK(g_ng_m68k.pc == 0x00005F72u);
    ...
    expected_state.a[7] = 0x000001F0u;
    expected_state.ssp = expected_state.a[7];
    CHECK(oracle_exec(program, (uint32_t)sizeof(program), 0x00005F80u,
                      &expected_state, expected_bus, 0));
    CHECK(expected_state.a[7] == 0x000001ECu);
    CHECK(bus_read32(expected_bus, 0x000001ECu) == 0x000001F0u);
    CHECK(bus_read32(expected_bus, 0x00001298u) == 0x000001F0u);
    CHECK(bus_read16(expected_bus, 0x0000129Cu) ==
          (uint16_t)(SR_S | CCR_X | CCR_N | CCR_Z | CCR_V | CCR_C));
    ...
    ng_generated_call(0x00005F80u);

    CHECK(g_dispatch_miss_count == 0);
    CHECK(g_ng_m68k.a[7] == expected_state.a[7]);
    CHECK(ng68k_read32(0x000001ECu) == 0x000001F0u);
    CHECK(ng68k_read32(0x00001298u) == 0x000001F0u);
    CHECK(ng68k_read16(0x0000129Cu) ==
          (uint16_t)(SR_S | CCR_X | CCR_N | CCR_Z | CCR_V | CCR_C));
    CHECK(memcmp(g_bus, expected_bus, sizeof(g_bus)) == 0);
    CHECK(g_ng_m68k.pc == 0x00005F92u);
    ...
    expected_state.a[7] = 0x00000100u;
    expected_state.ssp = expected_state.a[7];
    CHECK(oracle_exec(program, (uint32_t)sizeof(program), 0x00005FC0u,
                      &expected_state, expected_bus, 0));
    ...
    CHECK(g_ng_m68k.sr == expected_state.sr);
    CHECK(g_ng_m68k.a[0] == 0xFFFFFFFFu);
    CHECK(g_ng_m68k.a[7] == 0x0000026Cu);
    CHECK(ng68k_read32(0x000012A6u) == 0xFFFFFFFFu);
    CHECK(ng68k_read32(0x000012AAu) == 0xFFFFFFFFu);
    CHECK(g_ng_m68k.pc == 0x00005FDEu);
